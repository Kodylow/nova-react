...
const Examples: ExampleIndex[] = [
    ...
    { id: 'vertical-application-layouts', title: 'Vertical application layouts', type: 'section' },
    { id: "vertical-application-layout" },
    { id: "vertical-nav-layout" },
    { id: "styles-vertical" },
    { id: 'mixed-application-layouts', title: 'Mixed application layouts', type: 'section' },
    { id: "mixed-application-layout" },
    { id: "alternate-horizontal-nav-layout" },
    { id: "vertical-mixed-nav-layout" },
    { id: "styles-mixed" },
